  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        {!isFormOpen && (
          <button
            onClick={() => { setCreating(true); setEditing(null); setForm({ ...emptyGuide, iconSymbols: [] }); setErrors({}); setSaveError(null); }}
        ...
        <div className={`p-6 border ${darkMode ? 'bg-white/5 border-white/10' : 'bg-white border-gray-200'} space-y-6`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <label className={`text-xs mb-1 block ${darkMode ? 'text-white/50' : 'text-black/50'}`} style={{ fontFamily: '"Bebas Neue", sans-serif', letterSpacing: '0.1em' }}>
                INSTRUCTIONS (FR) <span className={darkMode ? 'text-white/30' : 'text-black/30'}>({language === 'fr' ? 'facultatif' : 'optional'})</span>
              </label>
            ...
            <div className="md:col-span-2">
              <label className={`text-xs mb-1 block ${darkMode ? 'text-white/50' : 'text-black/50'}`} style={{ fontFamily: '"Bebas Neue", sans-serif', letterSpacing: '0.1em' }}>
                INSTRUCTIONS (EN) <span className={darkMode ? 'text-white/30' : 'text-black/30'}>({language === 'fr' ? 'facultatif' : 'optional'})</span>
              </label>
          ...
          <div>
            <label className={`text-xs mb-3 block ${darkMode ? 'text-white/50' : 'text-black/50'}`} style={{ fontFamily: '"Bebas Neue", sans-serif', letterSpacing: '0.1em' }}>
              {language === 'fr' ? 'SYMBOLES D\'ENTRETIEN' : 'CARE SYMBOLS'} <span className={darkMode ? 'text-white/30' : 'text-black/30'}>({language === 'fr' ? 'facultatif' : 'optional'})</span>
            </label>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              ...
              <button onClick={() => { setEditing(null); setCreating(false); setErrors({}); setSaveError(null); }} className={`px-8 py-3 border ${darkMode ? 'border-white/20 hover:bg-white/5' : 'border-gray-200 hover:bg-gray-50'}`} style={{ fontFamily: '"Bebas Neue", sans-serif', letterSpacing: '0.1em' }}>
            ...
            <div key={guide.id} className={`border p-4 ${darkMode ? 'border-white/10 bg-white/5' : 'border-gray-200 bg-white'}`}>
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() => { setEditing(guide.id); setCreating(false); setErrors({}); setSaveError(null); setForm({ categorySlug: guide.categorySlug, nameFr: guide.nameFr, nameEn: guide.nameEn, instructionsFr: guide.instructionsFr, instructionsEn: guide.instructionsEn, iconSymbols: guide.iconSymbols || [], sortOrder: guide.sortOrder, isActive: guide.isActive }); }}
