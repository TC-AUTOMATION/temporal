...
const upsellSchema = z.object({
  ...
  triggerType: z.enum(['always', 'cart_total', 'product_in_cart', 'category_in_cart']),
  ...
  freeRequiredProductIds: z.array(z.string()).optional(),
  ...
  try {
    ...
    const upsell = await prisma.upsell.create({
      data: {
        ...
        freeRequiredProductIds: data.freeRequiredProductIds ?? [],
  ...
  try {
    ...
    const upsell = await prisma.upsell.update({
      ...
      data: {
        ...
        ...(data.freeRequiredProductIds !== undefined && { freeRequiredProductIds: data.freeRequiredProductIds }),
